...
export const SNIPPET_ITEMS: SnippetItem[] = [
  {
    ...
    previewLine: 'const debounced = useDebouncedValue(value, 300);',
  ...
  },
  {
    ...
    previewLine: 'await prisma.user.findFirst({ include: { posts: true } });',
  ...
  },
  {
    ...
    previewLine: 'df.groupby("category").agg({"price": "mean"})',
  ...
  },
  {
    ...
    previewLine: 'ctx, cancel := context.WithTimeout(ctx, 5*time.Second)',
  ...
  },
  {
    ...
    previewLine: 'fn process(data: &str) -> Result<(), Error> { ... }',
  ...
  },
  {
    ...
    previewLine: 'FROM node:20-alpine AS builder',
    topics: ['devops', 'build'],
    isStarred: false,
  },
  {
    ...
    previewLine: 'export const Card = memo(function Card({ item }) { ... });',
  ...
  },
  {
    ...
    previewLine: 'colors: { syntax: { accent: "#00eaff" } }',
  ...
  },
  {
    ...
    previewLine: 'CREATE INDEX idx_active_users ON users(email) WHERE active;',
